...
{
	$date = ($controller->_get->toString('date')) ? $controller->_get->toString('date') : date('Y-m-d');
	?>
	<ul class="list-group pjAsSelectedDateWrapper">
		<li class="list-group-item">
			<div class="row">
				<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pjAsSelectedDate">
					<?php __('front_selected_date');?>: <strong><?php echo date($tpl['option_arr']['o_date_format'], strtotime($date));?></strong>
				</div>
				<?php
				if(!isset($show_both))
				{ 
