				...
				<div class="alert alert-warning" role="alert">
					...
					if (isset($tpl['booking_arr']))
					{
						if(isset($tpl['params']['plugin']) && !empty($tpl['params']['plugin']))
						{
							...
							?><p class="text-center pjRbSectionSubTitle" data-payment="<?php echo $tpl['booking_arr']['payment_method']; ?>"><?php echo isset($payment_messages[$tpl['booking_arr']['payment_method']]) ? $payment_messages[$tpl['booking_arr']['payment_method']]: ''; ?><p><?php
